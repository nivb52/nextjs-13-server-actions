...
export default function ProfilForm({ user }: Props) {
    ...
    return (
        <section className="p-6 dark:bg-gray-800 dark:text-gray-50 bg-slate-50">
            <form onSubmit={() => console.log('success')} className="container flex flex-col mx-auto space-y-12 ng-untouched ng-pristine ng-valid">
                    ...
                    <div className="grid grid-cols-6 gap-4 col-span-full lg:col-span-3">
                        ...
                        <div className="col-span-full">
                            <div className="flex items-center space-x-2">
                                <button type="button" className="px-4 py-2 border rounded-md dark:border-gray-100 border-fuchsia-700">Save</button>
                            </div>
                        </div>
                    </div>
                </fieldset>
